...
from lerobot.utils.recording_annotations import resolve_collector_policy_id, resolve_collector_source
...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        if dataset is not None:
            ...
            if "complementary_info.collector_source" in dataset.features:
                frame["complementary_info.collector_source"] = resolve_collector_source(
